...
\fi
\begin{abstract}
Through this manual, we will learn how to setting up the ESP32 as a Master and Arduino as a Slave using I2C protocol.
\end{abstract}
...
\item
Connect the ESP32 pins to Arduino pins as per Table \ref{Table:1 Arduino-ESP}.
\begin{table}[h]
\centering
...
\item
Connect the ESP32 pins to LCD pins as per Table \ref{Table:2 ESP-LCD}.
\begin{table}[h]
\centering
\input{./vaman/esp32/I2C/figs/table2.tex}
\caption{}
...
\begin{lstlisting}
vaman/esp32/I2C/codes/I2C_Sender_Arduino/src/main.cpp
\end{lstlisting}
\item
Now configure ESP32 as a Master using the following code.\\
\begin{lstlisting}
vaman/esp32/I2C/codes/I2C_Reciever_ESP32/src/main.cpp
\end{lstlisting}
