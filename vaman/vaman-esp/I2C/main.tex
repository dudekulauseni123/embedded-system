...
\subsection{Setting up the I2C Comminication between Vaman-esp and Arduino}
...
\item
Configure Arduino Uno as a Slave and upload the following code into Arduino.\\
\begin{lstlisting}
vaman/vaman-esp/I2C/codes/I2C_Sender_Arduino/src/main.cpp
\end{lstlisting}

\item
Now configure vaman-ESP as a Master and upload the following code into Vaman-esp, after editing the Wi-fi Credentials.\\
\begin{lstlisting}
vaman/vaman-esp/I2C/codes/I2C_Reciever_ESP32/src/main.cpp
\end{lstlisting}
\item 
You should see the following message in LCD Display.
\begin{lstlisting}
I am Arduino
\end{lstlisting}
\end{enumerate}
