...
\chapter{Vaman-ARM}
This chapter contains various experiments that can be performed using the 
Vaman-ARM and Vaman-ESP32.
\section{Integrated Bluetooth-Controlled Seven-Segment Display}
\input{vaman-arm/bluetooth-sevenseg/main.tex}
\chapter{UGV}
\input{ugv/main.tex}
\chapter{Pulse Width Modulation}
This chapter contains various experiments related to Pulse Width Modulation 
(PWM).
\section{PWM Using SPI}
\input{vaman-arm/spi-pwm/spi-pwm.tex}
\backmatter
\appendix
\iffalse
